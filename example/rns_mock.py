...
class RNSMock:
    ...
    def register_request_handler(self, path: str, response_generator: tp.Callable, allow=None, allow_list=None):
    ...
    def request(self, path: str,
        ...
        return self.handlers[path](path, data, request_id, link_id, remote_identity, requested_at)
